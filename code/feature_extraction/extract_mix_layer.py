...
Extracts WavLM hidden-state features from the mixed (CMD-C + EDAIC) audio
utterances and saves them as numpy arrays for downstream classification.
...
layer to produce a 768-dimensional feature vector.
...
# === path settings ===
metadata_path = "utterance_table_mix_segmented_split.csv"
output_dir = f"features/features_mix_layer{args.layer}"
