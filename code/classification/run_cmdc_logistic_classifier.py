...
on the CMD-C (Chinese Mental-health Dialogue Corpus) dataset.
...
Usage:
    python run_cmdc_logistic_classifier.py
...
# set directory
feature_dir = "/scratch/s5944562/WavLM/features_cmdc_layer9"
output_file = "/scratch/s5944562/WavLM/output/cmdc_l9_results.txt"
