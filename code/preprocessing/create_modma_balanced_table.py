"""
create_modma_balanced_table.py
...
Reads utterance_table_modma_updated.csv, determines the minority class count
(min of HC and MDD), down-samples both classes to that count, shuffles the
result, and saves it to utterance_table_modma_balanced.csv. Unlike
...
Output:
    utterance_table_modma_balanced.csv -- Balanced CSV with equal class counts.
"""
